...
// Kazoe yakuman calculated separately
var yakumanSet = core.NewSet(
	KOKUSHI_MUSOU_YAKU,
	SUUANKOU_YAKU,
	DAISANGEN_YAKU,
	SHOUSUUSHII_YAKU,
...
var yakumanBitset = core.Reduce(yakumanSet, NO_YAKU, func(acc, yaku YakuType) YakuType {
	return acc | yaku
})

var canBeOpen = map[YakuType]bool{
	NO_YAKU:           true,
...
var hanLossOnOpen = map[YakuType]int{
	NO_YAKU: 0,
...
func hanValue(yaku YakuType, open bool) (han int) {
	han = yakuHan[yaku]
	if open {
		han -= hanLossOnOpen[yaku]
	}
	return han
}
