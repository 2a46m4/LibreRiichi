...
func (game *MahjongGameOld) setupGame() {
...
func (game *MahjongGameOld) drawNewTile() (Tile, error) {
...
func (game MahjongGameOld) lastTile() (Tile, error) {
	if game.TileIdx == 0 {
...
func (game *MahjongGameOld) currentPlayer() *Player {
	return &game.Players[game.currentPlayerIdx()]
}

func (game MahjongGameOld) currentPlayerIdx() uint8 {
	return game.OrderToPlayer[game.CurrentTurnOrder]
}

func (game MahjongGameOld) nextPlayerIdx() uint8 {
	return game.OrderToPlayer[game.CurrentTurnOrder+1]
}

func (game *MahjongGameOld) incrementTurn() {
	game.CurrentTurnOrder = (game.CurrentTurnOrder + 1) % 4
}

// Returns the index of the pending action
func (game MahjongGameOld) findAction(action Action, fromPlayer uint8) (int, error) {
...
func (game *MahjongGameOld) StartNewGame() ([][]Setup, error) {
