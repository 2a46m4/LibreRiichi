...
export class ThreeJSRenderer {
  ...
  toss(player_idx: number, tile: TileObject, riichi: boolean = false): void {
    this.hands[player_idx].remove_tile(tile)
    this.discard_pile[player_idx].add_to_pile(tile, riichi)
  }
  ...
  add_tile_to_end(tile: Tile, player_idx: number = 0) {
    this.hands[player_idx].add_tiles_to_last(tile)
  }
