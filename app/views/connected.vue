...
<template>
  <div :class="BoxStyling">
    ...
    <p>Room Name</p>
    <input :class="InputStyling" v-model="room_state.room_name" />
    <button :class="ButtonStyling" @click="find_room">Find</button>
  </div>
  <div :class="BoxStyling">
    <h1 :class="H1Styling">Create room</h1>
    <input :class="InputStyling" v-model="create_room_name" />
    <button :class="ButtonStyling" @click="create_room">Create</button>
  </div>
